...
public class PaymentController {
  ...
  @GetMapping("/users/{userId}/payment-details/{customerId}/payment-methods")
  public PaymentMethodResponse getPaymentMethods(
      @PathVariable String userId, @PathVariable String customerId) {
    List<PaymentMethod> data =
        paymentService.getPaymentMethods(customerId).stream().map(mapper::toRest).toList();
    return new PaymentMethodResponse().data(data);
  }

  @PutMapping("/users/{userId}/payment-details/{customerId}/payment-methods")
  public PaymentMethodResponse managePaymentMethod(
      @PathVariable String userId,
      @RequestBody PaymentMethodsAction paymentMethodsAction,
  ...
  @GetMapping("/users/{userId}/payment-details/{customerId}")
  public PaymentCustomer getPaymentCustomer(
      @PathVariable String userId, @PathVariable String customerId) {
    return customerMapper.toRest(paymentService.getCustomer(customerId));
  }
