...
public class LambdaFunctionLogMapper {
    public LogGroup toRest(software.amazon.awssdk.services.cloudwatchlogs.model.LogGroup AwsLogGroup) {
        return new LogGroup()
                .name(AwsLogGroup.logGroupName())
                .creationDatetime(Instant.ofEpochMilli(AwsLogGroup.creationTime()));
    }

    public List<LogGroup> toRest(List<software.amazon.awssdk.services.cloudwatchlogs.model.LogGroup> awsLogGroups) {
