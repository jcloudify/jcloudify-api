...
public class LambdaFunctionLogMapper {
  ...
  private LogStream toRestLogStream(software.amazon.awssdk.services.cloudwatchlogs.model.LogStream awsLogStream) {
  ...
  public List<LogStream> toRestLogStreams(List<software.amazon.awssdk.services.cloudwatchlogs.model.LogStream> awsLogStreams) {
