        ...
        .authorizeHttpRequests(
            (authorize) ->
                authorize
                    ...
                    .authenticated()
                    .requestMatchers(
                        selfApplicationMatcher(GET, "/users/*/applications/*/deployments/*/config"))
                    .authenticated()
                    .requestMatchers(
                        selfApplicationMatcher(GET, "/users/*/applications/*/deployments/*/states"))
                    .authenticated()
                    .requestMatchers(
                    ...
                    .requestMatchers(
                        selfApplicationMatcher(
                            GET,
                            "/users/*/applications/*/environments/*/functions/*/logStreamEvents"))
                    .authenticated()
