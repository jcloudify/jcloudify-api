...
@AllArgsConstructor
@Slf4j
public class CrupdateLogStreamEventTriggeredService implements Consumer<CrupdateLogStreamEventTriggered> {
    ...
    public void accept(CrupdateLogStreamEventTriggered crupdateLogStreamEventTriggered) {
        ...
        log.info("Crupdating log events of log group name={} log streams name={}", logGroupName, logStreamName);
