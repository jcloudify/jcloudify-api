...
public class RefreshUsersLogStreamsTriggeredService
  ...
  private List<String> getEnvironmentFunctions(String envId) {
  ...
  private List<LogGroup> getLogGroups(String bucketKey) {
    try {
  ...
  private void crupdateFunctionsLogStreams(
    ...
    List<String> functionNames = getEnvironmentFunctions(environment.getId());
  ...
  private void crupdateLogGroupsLogStreams(
    ...
    List<LogGroup> logGroupList = getLogGroups(logGroupBucketKey);
