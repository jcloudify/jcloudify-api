...
public class StackIT extends FacadeIT {
    ...
    void get_other_user_stack_list_ko() {
        ...
        assertThrowsForbiddenException(
                () -> api.getEnvironmentStacks(JANE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID, null, null),
                "Bad credentials");
    }
    ...
    void get_stack_by_id_ok() throws ApiException {
        ...
        Stack actualEventStack = api.getStackById(JOE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID, "event_stack_1_id");
        Stack actualBucketStack = api.getStackById(JOE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID, "bucket_stack_1_id");
    ...
    void get_other_user_stack_by_id_ko() {
        ...
        assertThrowsForbiddenException(
                () -> api.getStackById(JANE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID, "compute_perm_stack_1_id"),
                "Bad credentials");
    }
}
