...
public class EventModelSerializationIT extends MockedThirdParties {
    ...
    void app_env_compute_deploy_requested_serialization() throws JsonProcessingException {
        var appEnvComputeRequested = new AppEnvComputeDeployRequested(
                JOE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID,MOCK_BUCKET_KEY, "mock_app_name", PROD, MOCK_INSTANT);
    ...
    void check_template_integrity_triggered_serialization() throws JsonProcessingException {
        var checkTemplateIntegrityTriggered = new CheckTemplateIntegrityTriggered(
                JOE_DOE_ID, POJA_APPLICATION_ID, POJA_APPLICATION_ENVIRONMENT_ID,MOCK_BUCKET_KEY, MOCK_BUCKET_KEY, builtEnvInfo(),"deployment_conf_id");
